...
public class CustomBlockEntityRenderer implements BlockEntityRenderer<TrainingCustomBlockEntity> {
    ...
    public void render(TrainingCustomBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        //Render Layer Custom
        exampleVertexCustomRenderLayer(new Vector3f(0,10,0),id("textures/block/triangle_template.png"),matrices,vertexConsumers);
        //VERTEX CONSUMER
    ...
    public void exampleVertexCustomRenderLayer(Vector3f center, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers) {
    ...
    private static void exampleVertexLoadAndAnimateJsonModel(Vector3f center, TrainingCustomBlockEntity entity, MatrixStack matrices, VertexConsumerProvider vertexConsumers) {
        matrices.push();
        matrices.translate(center.x,center.y, center.z);
    ...
    private void exampleVertexRenderLayerIcosahedronEnd(Vector3f center, float scale, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
    ...
    private void exampleVertexTexturedIcosahedron(Vector3f center, float scale, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        Vector3f[] ICOSAHEDRON_VERTICES = getIcosahedronVertices();
    ...
    private Vector3f scaleAndTranslate(Vector3f point, Vector3f center, float scale) {
        return new Vector3f(
    ...
    private void exampleVertexTexturedTrianglesInCircle(Vector3f center, int numTriangles, float radius, float tipLength, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay){
    ...
    private void drawTexturedTriangle(Vector3f point1, Vector3f point2, Vector3f point3, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay){
        matrices.push();
    ...
    private void exampleVertexTexturedTriangle(Vector3f center,Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();
        ...
        private void exampleTexturedTriangle(Vector3f center, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();
        matrices.translate(center.x,center.y, center.z);
    ...
    private void exampleTessellatorRGBTriangle(Vector3f center, MatrixStack matrices) {
        matrices.push();
        matrices.translate(center.x,center.y, center.z);
    ...
    private void exampleVertexRotatingCubesDraw(Vector3f center, TrainingCustomBlockEntity entity, VertexConsumerProvider vertexConsumers, MatrixStack matrices, int light, int overlay){
