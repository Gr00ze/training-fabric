...
public class EntityTypeList {
    public static EntityType<? extends MobEntity> DUMMY_MOB_ENTITY = registerEntityType("dummy",EntityType.Builder.create(DummyMobEntity::new, SpawnGroup.CREATURE).dimensions(2,2));
    public static EntityType<? extends MobEntity> DUMMY_AI_ENTITY = registerEntityType("dummy_ai",EntityType.Builder.create(DummyAIEntity::new, SpawnGroup.CREATURE).dimensions(2,2));
